...
import 'package:e_learning_app/app/data/services/mock_service.dart';
...
class ApiService extends GetxService {
  ...
  Future<void> _saveAuthToken({required String accessToken,required String refreshToken}) async {
    try {
